...
public class HomeController {
    ...
    public String processAddJobForm(@ModelAttribute @Valid Job newJob, Errors errors, Model model, @RequestParam int employerId, @RequestParam List<Integer> skills) {
        ...
        Optional<Employer> myEmployer = employerRepository.findById(employerId);
        newJob.setEmployer(myEmployer.get());

        List<Skill> mySkills = (List<Skill>) skillRepository.findAllById(skills);
        newJob.setSkills(mySkills);
